...
// 		pw.println("}</script>");
// 		pw.println("<script src='https://maps.googleapis.com/maps/api/js?key=AIzaSyBIwzALxUPNbatRBj3Xi1Uhp0fFzwWNBkE&callback=initMap&libraries=&v=weekly' defer></script>");
// 		pw.println("<div class='6u'><section><header><div align='center'><section><h2>Recommandation:Doctor</h2></section></div><hr><table style='width:100% '>");
...
// 			pw.println("<td>" + utility.getDistance(user.getLat(), user.getLongt(), doctor.getLat()  ,  doctor.getLongt())  +" miles</td>");
